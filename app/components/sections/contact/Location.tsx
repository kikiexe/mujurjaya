  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold mb-8 sm:mb-10 md:mb-12">
        ...
        <div className="w-full max-w-4xl mx-auto h-64 sm:h-80 md:h-96 lg:h-[500px] rounded-lg sm:rounded-xl shadow-lg sm:shadow-xl overflow-hidden border border-gray-200">
          <iframe
